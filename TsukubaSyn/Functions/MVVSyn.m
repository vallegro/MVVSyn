...
dZ_maxs = zeros(seq_end - seq_start +1, 1); 
...
for i = seq_start:seq_end, 
    ...
    dZ_maxs(i) = MaxZShiftCal(di_r, di_l);
end

dZ_max = max(dZ_maxs);

parfor i = seq_start:seq_end,
    ...
    for zpos = 1:zpos_num,
        for xpos = 1:xpos_num,
            ...
            [dX,dZ] = XZShiftCal(1, xpos, xpos_num, 1, zpos, zpos_num, dZ_max, SR_f);
            
            [im_7_from_l, di_7_from_l, di_t_7_from_l] = ...
                DIBRxz( dX, dZ, im_l, di_l, SR_f);

            [dX,dZ] = XZShiftCal(7, xpos, xpos_num, 1, zpos, zpos_num, dZ_max, SR_f);
